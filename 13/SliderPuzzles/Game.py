...
class Game:
    ...
    def __init__(self, window):
        ...
        self.soundTick = pygame.mixer.Sound(BASE_PATH / "sounds/tick.wav")
        self.soundApplause = pygame.mixer.Sound(BASE_PATH / "sounds/applause.wav")
        self.soundNope = pygame.mixer.Sound(BASE_PATH / "sounds/nope.wav")
