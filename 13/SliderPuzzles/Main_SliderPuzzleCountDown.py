...
restartButton = pygwidgets.CustomButton(
    window,
    (320, 455),
    up=BASE_PATH / "images/restartButtonUp.jpg",
    down=BASE_PATH / "images/restartButtonDown.jpg",
    over=BASE_PATH / "images/restartButtonOver.jpg",
)

# 5 - Initialize variables
clock = pygame.time.Clock()

timerDisplay = pygwidgets.DisplayText(
    window, (50, 465), "", fontSize=36, textColor=WHITE
)

messageDisplay = pygwidgets.DisplayText(
    window, (50, 510), "Click on a tile to move it.", fontSize=36, textColor=WHITE
)

oGame = Game(window)  # create the main game object
soundBuzz = pygame.mixer.Sound(BASE_PATH / "sounds/buzz.wav")
...
while True:
    ...
    timeToShow = oCountDownTimer.getTimeInHHMMSS(
        2
    )  # ask the clock object for the elapsed time
