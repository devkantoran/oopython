...
oHeaderMessage = pygwidgets.DisplayText(
    window,
    (0, 50),
    "Click Start to start a timer:",
    fontSize=36,
    justified="center",
    width=WINDOW_WIDTH,
)
...
oTimerMessage = pygwidgets.DisplayText(
    window,
    (66, 160),
    "getTimeInSeconds      getTimeInHHMMSS",
    fontSize=36,
    width=WINDOW_WIDTH,
)

oTimerDisplaySeconds = pygwidgets.DisplayText(
    window, (220, 190), "", fontSize=36, justified="right"
)
oTimerDisplayHHMMSS = pygwidgets.DisplayText(
    window, (356, 190), "", fontSize=36, justified="right"
)
