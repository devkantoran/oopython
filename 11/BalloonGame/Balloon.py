...
class Balloon(ABC):
    ...
    def __init__(self, window, maxWidth, maxHeight, ID, oImage, size, nPoints, speedY):
        ...
        if not Balloon.popSoundLoaded:  # load first time only
            ...
            Balloon.popSound = pygame.mixer.Sound(BASE_PATH / "sounds/balloonPop.wav")
...
class BalloonSmall(Balloon):
    balloonImage = pygame.image.load(BASE_PATH / "images/redBalloonSmall.png")
...
class BalloonMedium(Balloon):
    balloonImage = pygame.image.load(BASE_PATH / "images/redBalloonMedium.png")
...
class BalloonLarge(Balloon):
    balloonImage = pygame.image.load(BASE_PATH / "images/redBalloonLarge.png")
