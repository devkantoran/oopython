...
class SceneC(pyghelpers.Scene):
    def __init__(self, window):
        ...
        self.gotoAButton = pygwidgets.TextButton(
            self.window, (100, 100), "Go to Scene A"
        )
        self.gotoBButton = pygwidgets.TextButton(
            self.window, (250, 100), "Go to Scene B"
        )
        self.gotoCButton = pygwidgets.TextButton(
            self.window, (400, 100), "Go to Scene C"
        )
