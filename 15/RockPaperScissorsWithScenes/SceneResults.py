...
class SceneResults(pyghelpers.Scene):
    def __init__(self, window):
        ...
        self.playerScoreCounter = pygwidgets.DisplayText(
            self.window, (86, 315), "Score:", fontSize=50, textColor=WHITE
        )

        self.computerScoreCounter = pygwidgets.DisplayText(
            self.window, (384, 315), "Score:", fontSize=50, textColor=WHITE
        )
        # Sounds
        self.winnerSound = pygame.mixer.Sound(SOUND_PATH + "ding.wav")
        self.tieSound = pygame.mixer.Sound(SOUND_PATH + "push.wav")
        self.loserSound = pygame.mixer.Sound(SOUND_PATH + "buzz.wav")
