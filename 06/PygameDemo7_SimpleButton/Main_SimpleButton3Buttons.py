...
oButtonA = SimpleButton(
    window, (25, 30), "images/buttonAUp.png", "images/buttonADown.png", BASE_PATH
)
oButtonB = SimpleButton(
    window, (150, 30), "images/buttonBUp.png", "images/buttonBDown.png", BASE_PATH
)
oButtonC = SimpleButton(
    window, (275, 30), "images/buttonCUp.png", "images/buttonCDown.png", BASE_PATH
)
