...
def showCustomYesNoDialog(theWindow, theText):
    oDialogBackground = pygwidgets.Image(
        theWindow, (40, 250), IMAGE_PATH + "dialog.png"
    )
    ...
    oYesButton = pygwidgets.CustomButton(
        theWindow,
        (320, 370),
        IMAGE_PATH + "gotoHighScoresNormal.png",
...
class ScenePlay(pyghelpers.Scene):
    def __init__(self, window):
        ...
        self.controlsBackground = pygwidgets.Image(
            self.window, (0, GAME_HEIGHT), IMAGE_PATH + "controlsBackground.jpg"
        )
        ...
        self.newGameButton = pygwidgets.CustomButton(
            self.window,
            (450, GAME_HEIGHT + 90),
            up=IMAGE_PATH + "startNewNormal.png",
            down=IMAGE_PATH + "startNewDown.png",
            over=IMAGE_PATH + "startNewOver.png",
            disabled=IMAGE_PATH + "startNewDisabled.png",
        ...
        self.gameOverImage = pygwidgets.Image(
            self.window, (140, 180), IMAGE_PATH + "gameOver.png"
        )
        ...
        pygame.mixer.music.load(SOUND_PATH + "background.mid")
        self.dingSound = pygame.mixer.Sound(SOUND_PATH + "ding.wav")
        self.gameOverSound = pygame.mixer.Sound(SOUND_PATH + "gameover.wav")
