...
class TextView:
    def __init__(self, window, oModel):
        ...
        self.oTotalDisplay = pygwidgets.DisplayText(
            self.window,
            (200, 135),
            totalText,
            fontSize=36,
        ...
        self.oCountDisplay = pygwidgets.DisplayText(
            self.window, (320, 135), fontSize=36, width=120, justified="right"
        )
        self.oPercentDisplay = pygwidgets.DisplayText(
            self.window, (440, 135), fontSize=36, width=120, justified="right"
        )
