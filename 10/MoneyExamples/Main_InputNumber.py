...
title = pygwidgets.DisplayText(
    window,
    (0, 40),
    "Demo of InputText and InputNumber fields",
    fontSize=36,
    width=WINDOW_WIDTH,
    justified="center",
)

inputTextCaption = pygwidgets.DisplayText(
    window, (20, 150), "Input any text:", fontSize=24, width=190, justified="right"
)
oInputText = pygwidgets.InputText(window, (230, 150), "", width=150)
okButtonText = pygwidgets.TextButton(window, (430, 150), "OK")

inputNumberCaption = pygwidgets.DisplayText(
    window, (20, 250), "Input number only:", fontSize=24, width=190, justified="right"
)
