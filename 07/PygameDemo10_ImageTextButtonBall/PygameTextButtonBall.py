...
print(BASE_PATH / "images/ball.png")
...
oBall = pygwidgets.Image(
    window,
    (0, 0),
    "07/PygameDemo10_ImageTextButtonBall/images/ball.png",
)
ballLeft = 0
ballTop = 0
...
oBackground = pygwidgets.Image(
    window, (0, 0), "07/PygameDemo10_ImageTextButtonBall/images/background.jpg"
)

oRestartButton = pygwidgets.CustomButton(
    window,
    (500, 430),
    up=BASE_PATH / "images/restartUp.png",
    down=BASE_PATH / "images/restartDown.png",
    over=BASE_PATH / "images/restartOver.png",
    disabled=BASE_PATH / "images/restartDisabled.png",
)

oHitMeButton = pygwidgets.TextButton(window, (500, 370), "Hit Me")

oMessageTextA = pygwidgets.DisplayText(
    window, (20, 50), "Here is some text", fontSize=36, textColor=WHITE
)

oMessageTextB = pygwidgets.DisplayText(
    window,
    (20, 150),
    "Here is more text\nAnd more text\nAnd even more text",
    fontSize=36,
...
oUserInputA = pygwidgets.InputText(
    window, (20, 350), "", fontSize=24, textColor=BLACK, backgroundColor=WHITE
)

oUserInputB = pygwidgets.InputText(
    window,
    (20, 430),
    "",
    width=400,
