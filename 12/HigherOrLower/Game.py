...
class Game:
    ...
    def __init__(self, window):
        ...
        self.loserSound = pygame.mixer.Sound(BASE_PATH / "sounds/loser.wav")
        self.winnerSound = pygame.mixer.Sound(BASE_PATH / "sounds/ding.wav")
        self.cardShuffleSound = pygame.mixer.Sound(BASE_PATH / "sounds/cardShuffle.wav")
